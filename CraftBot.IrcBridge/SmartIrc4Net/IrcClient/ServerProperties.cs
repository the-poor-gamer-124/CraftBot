...
namespace Meebey.SmartIrc4net
{
    ...
    public class ServerProperties
    {
        ...
        /// </summary>
        internal ServerProperties() => this.RawProperties = new Dictionary<string, string>();
        ...
        private string[] SplitChannelModes
        {
            get
            {
                if (!this.HaveNonNullKey("CHANMODES"))
                {
                    return null;
                }
                string[] splits = this.RawProperties["CHANMODES"].Split(',');
        ...
        public char? BanExceptionCharacter
        {
            get
            {
                if (!this.RawProperties.ContainsKey("EXCEPTS"))
                {
                    return null;
                }

                string exstr = this.RawProperties["EXCEPTS"];
                if (exstr == null)
                {
                    // default: +e
                    return 'e';
        ...
        public CaseMappingType CaseMapping
        {
            get
            {
                if (!this.HaveNonNullKey("CASEMAPPING"))
                {
                    // default is rfc1459
                    return CaseMappingType.Rfc1459;
                }

                switch (this.RawProperties["CASEMAPPING"])
                {
                    case "ascii":
        ...
        /// </summary>
        public IDictionary<string, int> ChannelJoinLimits => this.ParseStringNumberPairs("CHANLIMIT", null, null, -1);
        ...
        public int ChannelNameLength
        {
            get
            {
                ...
                int? len = this.ParseNumber("CHANNELLEN", 200, 200);
                return len ?? -1;
            }
        }
        ...
        public IList<KeyValuePair<char, char>> ChannelPrivilegeModesPrefixes
        {
            get
            {
                ...
                if (!this.RawProperties.ContainsKey("PREFIX"))
                {
                ...
                string prefixstr = this.RawProperties["PREFIX"];
                if (prefixstr == null)
                {
                    // supports no modes (!)
                    return modesList;
        ...
        public char[] ChannelTypes
        {
            get
            {
                if (!this.HaveNonNullKey("CHANTYPES"))
                {
                    // sane default
                    return "#&".ToCharArray();
                }

                return this.RawProperties["CHANTYPES"].ToCharArray();
            }
        }
        ...
        public char? InviteExceptionCharacter
        {
            get
            {
                if (!this.RawProperties.ContainsKey("INVEX"))
                {
                    return null;
                }

                string exstr = this.RawProperties["INVEX"];
                if (exstr == null)
                {
                    // default: +I
                    return 'I';
        ...
        /// </summary>
        public int? KickMessageLength => this.ParseNumber("KICKLEN", null, null);
        ...
        public string ListChannelModes
        {
            get
            {
                string[] splitmodes = this.SplitChannelModes;
                return splitmodes?[0];
            }
        }
        ...
        public ListExtensions ListExtensions
        {
            get
            {
                if (!this.HaveNonNullKey("ELIST"))
                {
                    return ListExtensions.None;
                }

                string eliststr = this.RawProperties["ELIST"];
                ListExtensions exts = ListExtensions.None;
        ...
        /// </summary>
        public bool ListIsSafe => this.RawProperties.ContainsKey("SAFELIST");
        ...
        /// </summary>
        public IDictionary<string, int> ListModeLimits => this.ParseStringNumberPairs("MAXLIST", null, null, -1);
        ...
        public IDictionary<string, int> MaxCommandTargets
        {
            get
            {
                ...
                return this.ParseStringNumberPairs("TARGMAX", emptydict, null, -1);
            }
        }
        ...
        public int? MaxNicknameLength
        {
            get
            {
                ...
                return this.ParseNumber("NICKLEN", 9, null);
            }
        }
        ...
        public int? MaxParametricModeSets
        {
            get
            {
                ...
                return this.ParseNumber("MODES", 3, -1);
            }
        }
        ...
        public int MaxSilenceListEntries
        {
            get
            {
                ...
                return this.ParseNumber("SILENCE", 0, 0) ?? 0;
            }
        }
        ...
        public int MaxTopicLength
        {
            get
            {
                ...
                return this.ParseNumber("TOPICLEN", -1, -1) ?? -1;
            }
        }
        ...
        public int MaxWatchListEntries
        {
            ...
            {
                // SILENCE requires a value, but assume 0 if unspecified
                return this.ParseNumber("WATCH", 0, 0) ?? 0;
            }
        }
        ...
        /// </summary>
        public string NetworkName => !this.HaveNonNullKey("NETWORK") ? null : this.RawProperties["NETWORK"];
        ...
        /// </summary>
        public string ParametricChannelModes => this.SplitChannelModes?[1];
        ...
        public string StatusNoticeParticipants
        {
            get
            {
                if (!this.HaveNonNullKey("STATUSMSG"))
                {
                    // STATUSMSG requires a value, but assume none
                    // if unspecified
                    return "";
                }
                return this.RawProperties["STATUSMSG"];
            }
        }
        ...
        /// </summary>
        public bool SupportsChannelParticipantNotices => this.RawProperties.ContainsKey("CNOTICE");
        ...
        /// </summary>
        public bool SupportsChannelParticipantPrivMsgs => this.RawProperties.ContainsKey("CPRIVMSG");
        ...
        /// dictionary.</returns>
        private bool HaveNonNullKey(string key) => this.RawProperties.ContainsKey(key) ? this.RawProperties[key] != null : false;
        ...
        {
            if (!this.RawProperties.ContainsKey(key))
            {
                return unsetDefault;
            }
            string numstr = this.RawProperties[key];
            return numstr == null ? emptyDefault : !int.TryParse(numstr, out int num) ? null : (int?)num;
        }
        ...
        private IDictionary<string, int> ParseStringNumberPairs(string key, IDictionary<string, int> unsetDefault, IDictionary<string, int> emptyDefault, int? defaultValue)
        {
            ...
            string valstr = this.RawProperties[key];
            if (valstr == null)
            {
                return emptyDefault;
            }
        ...
        internal void ParseFromRawMessage(string[] rawMessage)
        {
            ...
            for (int i = 3; i < rawMessage.Length; ++i)
            {
                ...
                {
                    // keyword only
                    this.RawProperties[keyval[0]] = null;
                }
                else if (keyval.Length == 2)
                {
                    // key and value
                    this.RawProperties[keyval[0]] = keyval[1];
                }
                else
                {
#if LOG4NET
