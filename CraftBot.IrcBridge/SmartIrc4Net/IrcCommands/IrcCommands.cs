...
namespace Meebey.SmartIrc4net
{
    ...
    public class IrcCommands : IrcConnection
    {
        ...
        public void SendMessage(SendType type, string destination, string message, Priority priority)
        {
            switch(type) {
                ...
                case SendType.Action:
                    this.RfcPrivmsg(destination, "\x1"+"ACTION "+message+"\x1", priority);
                break;
                case SendType.Notice:
                    this.RfcNotice(destination, message, priority);
                break;
                case SendType.CtcpRequest:
                    this.RfcPrivmsg(destination, "\x1"+message+"\x1", priority);
                break;
                case SendType.CtcpReply:
                    this.RfcNotice(destination, "\x1"+message+"\x1", priority);
                break;
            }
        }
        ...
        public void ChangeChannelPrivilege(string modechg, string channel, string nickname, Priority priority) => this.WriteLine(Rfc2812.Mode(channel, modechg + " " + nickname), priority);
        ...
        /// <param name="channel">The channel in which to perform the privilege change.</param>
        /// <param name="nickname">The nickname of the user whose privilege is being changed.</param>
        public void ChangeChannelPrivilege(string modechg, string channel, string nickname) => this.WriteLine(Rfc2812.Mode(channel, modechg + " " + nickname));
        ...
        public void Op(string channel, string nickname, Priority priority) => this.ChangeChannelPrivilege("+o", channel, nickname, priority);

        public void Op(string channel, string[] nicknames) => this.ChangeChannelPrivilege("+o", channel, nicknames);

        public void Op(string channel, string nickname) => this.ChangeChannelPrivilege("+o", channel, nickname);

        public void Deop(string channel, string nickname, Priority priority) => this.ChangeChannelPrivilege("-o", channel, nickname, priority);

        public void Deop(string channel, string[] nicknames) => this.ChangeChannelPrivilege("-o", channel, nicknames);

        public void Deop(string channel, string nickname) => this.ChangeChannelPrivilege("-o", channel, nickname);

        public void Voice(string channel, string nickname, Priority priority) => this.ChangeChannelPrivilege("+v", channel, nickname, priority);

        public void Voice(string channel, string[] nicknames) => this.ChangeChannelPrivilege("+v", channel, nicknames);

        public void Voice(string channel, string nickname) => this.ChangeChannelPrivilege("+v", channel, nickname);

        public void Devoice(string channel, string nickname, Priority priority) => this.ChangeChannelPrivilege("-v", channel, nickname, priority);

        public void Devoice(string channel, string[] nicknames) => this.ChangeChannelPrivilege("-v", channel, nicknames);

        public void Devoice(string channel, string nickname) => this.ChangeChannelPrivilege("-v", channel, nickname);
        ...
        public void ListChannelMasks(string modetype, string channel) => this.WriteLine(Rfc2812.Mode(channel, modetype));
        ...
        /// <param name="channel">The channel whose mode to fetch.</param>
        /// <param name="priority">The priority with which the mode-setting message should be sent.</param>
        public void ListChannelMasks(string modetype, string channel, Priority priority) => this.WriteLine(Rfc2812.Mode(channel, modetype), priority);
        ...
        /// <param name="priority">The priority with which the mode-setting message should be sent.</param>
        public void ModifyChannelMasks(string modetype, string channel, string hostmask, Priority priority) => this.WriteLine(Rfc2812.Mode(channel, modetype + " " + hostmask), priority);
        ...
        /// <param name="channel">The channel whose mode to edit.</param>
        /// <param name="hostmask">The hostmask of the entry to add/remove.</param>
        public void ModifyChannelMasks(string modetype, string channel, string hostmask) => this.WriteLine(Rfc2812.Mode(channel, modetype + " " + hostmask));
        ...
        public void ModifyChannelMasks(string modetype, string channel, string[] hostmasks)
        {
            ...
            this.Mode(channel, modes, hostmasks);
        }

        public void Ban(string channel) => this.ListChannelMasks("+b", channel);

        public void Ban(string channel, string hostmask, Priority priority) => this.ModifyChannelMasks("+b", channel, hostmask, priority);

        public void Ban(string channel, string hostmask) => this.ModifyChannelMasks("+b", channel, hostmask);

        public void Ban(string channel, string[] hostmasks) => this.ModifyChannelMasks("+b", channel, hostmasks);

        public void Unban(string channel, string hostmask, Priority priority) => this.ModifyChannelMasks("-b", channel, hostmask, priority);

        public void Unban(string channel, string hostmask) => this.ModifyChannelMasks("-b", channel, hostmask);

        public void Unban(string channel, string[] hostmasks) => this.ModifyChannelMasks("-b", channel, hostmasks);

        public virtual void BanException(string channel) => this.ListChannelMasks("+e", channel);

        public virtual void BanException(string channel, string hostmask, Priority priority) => this.ModifyChannelMasks("+e", channel, hostmask, priority);

        public virtual void BanException(string channel, string hostmask) => this.ModifyChannelMasks("+e", channel, hostmask);

        public virtual void BanException(string channel, string[] hostmasks) => this.ModifyChannelMasks("+e", channel, hostmasks);

        public virtual void UnBanException(string channel, string hostmask, Priority priority) => this.ModifyChannelMasks("-e", channel, hostmask, priority);

        public virtual void UnBanException(string channel, string hostmask) => this.ModifyChannelMasks("-e", channel, hostmask);

        public virtual void UnBanException(string channel, string[] hostmasks) => this.ModifyChannelMasks("-e", channel, hostmasks);

        public virtual void InviteException(string channel) => this.ListChannelMasks("+I", channel);

        public virtual void InviteException(string channel, string hostmask, Priority priority) => this.ModifyChannelMasks("+I", channel, hostmask, priority);

        public virtual void InviteException(string channel, string hostmask) => this.ModifyChannelMasks("+I", channel, hostmask);

        public virtual void InviteException(string channel, string[] hostmasks) => this.ModifyChannelMasks("+I", channel, hostmasks);

        public virtual void UnInviteException(string channel, string hostmask, Priority priority) => this.ModifyChannelMasks("-I", channel, hostmask, priority);

        public virtual void UnInviteException(string channel, string hostmask) => this.ModifyChannelMasks("-I", channel, hostmask);

        public virtual void UnInviteException(string channel, string[] hostmasks) => this.ModifyChannelMasks("-I", channel, hostmasks);

        // non-RFC commands

        public void Owner(string channel, string nickname, Priority priority) => this.ChangeChannelPrivilege("+q", channel, nickname, priority);

        public void Owner(string channel, string[] nicknames) => this.ChangeChannelPrivilege("+q", channel, nicknames);

        public void Owner(string channel, string nickname) => this.ChangeChannelPrivilege("+q", channel, nickname);

        public void Deowner(string channel, string nickname, Priority priority) => this.ChangeChannelPrivilege("-q", channel, nickname, priority);

        public void Deowner(string channel, string[] nicknames) => this.ChangeChannelPrivilege("-q", channel, nicknames);

        public void Deowner(string channel, string nickname) => this.ChangeChannelPrivilege("-q", channel, nickname);

        public void ChanAdmin(string channel, string nickname, Priority priority) => this.ChangeChannelPrivilege("+a", channel, nickname, priority);

        public void ChanAdmin(string channel, string[] nicknames) => this.ChangeChannelPrivilege("+a", channel, nicknames);

        public void ChanAdmin(string channel, string nickname) => this.ChangeChannelPrivilege("+a", channel, nickname);

        public void DeChanAdmin(string channel, string nickname, Priority priority) => this.ChangeChannelPrivilege("-a", channel, nickname, priority);

        public void DeChanAdmin(string channel, string[] nicknames) => this.ChangeChannelPrivilege("-a", channel, nicknames);

        public void DeChanAdmin(string channel, string nickname) => this.ChangeChannelPrivilege("-a", channel, nickname);

        public void Halfop(string channel, string nickname, Priority priority) => this.ChangeChannelPrivilege("+h", channel, nickname, priority);

        public void Halfop(string channel, string[] nicknames) => this.ChangeChannelPrivilege("+h", channel, nicknames);

        public void Halfop(string channel, string nickname) => this.ChangeChannelPrivilege("+h", channel, nickname);

        public void Dehalfop(string channel, string nickname, Priority priority) => this.ChangeChannelPrivilege("-h", channel, nickname, priority);

        public void Dehalfop(string channel, string[] nicknames) => this.ChangeChannelPrivilege("-h", channel, nicknames);

        public void Dehalfop(string channel, string nickname) => this.ChangeChannelPrivilege("-h", channel, nickname);
        ...
        public void Mode(string target, string[] newModes, string[] newModeParameters)
        {
            ...
            int maxModeChanges = this.MaxModeChanges;
            for (int i = 0; i < newModes.Length; i += maxModeChanges) {
                ...
                this.WriteLine(Rfc2812.Mode(target, newModeChunks.ToArray(),
        ...
        /// <param name="remoteserver"></param>
        /// <param name="priority"></param>
        public void RfcConnect(string targetserver, string port, string remoteserver, Priority priority) => this.WriteLine(Rfc2812.Connect(targetserver, port, remoteserver), priority);
